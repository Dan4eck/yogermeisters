export const siteCopy = {
  en: {
    ...
    tours: {
      ...
      detailCtaDescription:
        'Message me in Telegram, and I will send you the current details, availability, and the next booking step.',
      dateLocale: 'en-US',
    },
    classes: {
    ...
    reviews: {
      ...
      description: 'Personal stories from practice, retreats, and the quiet changes that stay after.',
  ...
  ru: {
    ...
    tours: {
      ...
      detailCtaTitle: '📿 Готов присоединиться к ретриту?',
      detailCtaDescription:
        'Напиши мне в Telegram, и я отправлю актуальные детали, наличие мест и расскажу, как сделать бронирование.',
      dateLocale: 'ru-RU',
    },
    classes: {
    ...
    reviews: {
      ...
      description: 'Опыт участиков моих ретритов 🫶',
