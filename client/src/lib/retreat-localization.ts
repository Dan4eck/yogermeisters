  ...
  ru: {
    1: {
      ...
      postBlocks: {
        ...
        pricing: {
          text: 'Формат all-inclusive: проживание, завтраки, практики, SUP/лодки и трансферы. Стоимость: €790. Депозит €200, возвратный до 10 сентября, возможна оплата частями.',
        },
        'teacher-image': {
