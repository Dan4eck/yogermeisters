...
const retreatTranslationById: Record<Language, Record<number, LocalizedRetreatContent>> = {
  ...
  ru: {
    1: {
      ...
      postBlocks: {
        intro: {
          text: 'Мой любимый 7-дневный ретрит в Чиралы для глубокой перезагрузки тела, ума и энергии. Это место между морем и горами быстро возвращает в живое, ясное и спокойное состояние.',
        },
        'practice-overview': {
        ...
        pricing: {
          text: 'Формат all-inclusive: проживание, завтраки, практики, SUP/лодки и трансферы. Стоимость: €750. Спецпредложение: €720 для первых участников (осталось 3 места). Депозит €200, возможна оплата частями.',
        },
        'teacher-image': {
