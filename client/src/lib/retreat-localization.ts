  ...
  ru: {
    ...
    3: {
      ...
      postBlocks: {
        ...
        closing: {
          text: 'Финальные дни посвящены более глубокой интеграции: горная тишина, практика на рассвете и более мягкий ритм, чтобы опыт успел уложиться в теле и уме перед возвращением домой.',
        },
        'integration-image': {
