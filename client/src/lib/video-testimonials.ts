  ...
  en: [
    {
      ...
      program: 'Retreat',
      duration: '00:57',
      quote: 'Anastasia made tantra feel joyful, approachable, and unexpectedly easy to enter.',
      outcome: 'A playful first contact with tantra and a memorable retreat atmosphere',
      preview:
        'This guest describes the weekend as a rare mix of depth and lightness, where new practices felt safe, fun, and genuinely exciting to explore.',
      videoUrl: `${SELECTEL_PUBLIC_BASE}/testimonial-01-en.mp4`,
      posterUrl: `${SELECTEL_PUBLIC_BASE}/testimonial-01-en-poster.jpg`,
      captionsUrl: '',
      tags: ['Tantra', 'Weekend', 'Retreat'],
      featured: true,
    },
    {
